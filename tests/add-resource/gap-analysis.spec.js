// Gap-analysis additions to Add Resource, from the newly restructured
// CEP_TestCases/Add_Resource_Module_Test_Cases_Final.xlsx.
// Cases: ADD-WB-01, ADD-XREF-01, AR-CYP-01..08, AR-GAP-01..02, ADD-EXP-01..08.
//
...
test('ADD-XREF-01: Gallery, Drop It, AI Assist, and Library are each covered in their own dedicated module workbooks', { tag: '@cross-cutting' }, async ({ page }) => {
  ...
  // those other module's own spec files (gallery.spec.js, dropit-ai-assist
  // .spec.js, library.spec.js).
  const ar = new AddResourcePage(page);
  await ar.openPicker();
