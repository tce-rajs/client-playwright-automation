// Gap-analysis additions to TCE Search Library, from the newly restructured
// CEP_TestCases/TCE_Search_Library_Module_Test_Cases_Final.xlsx (29 rows).
// ADD-LIB-01..07 are already covered in tests/add-resource/library.spec.js;
// this file covers the remaining 22: TCE-PREV-01..04, TCE-BOUND-01..02,
// TCE-SEC-01, TCE-XCUT-01, LIB-TYPE-MIX-01, LIB-AUTOSEARCH-RACE-01,
// LIB-WORKSHEET-POOL-01, LIB-STUCK-PREVIEW-01, LIB-PREVTYPE-GAP-01,
// LIB-FOOTERBTN-01, LIB-BOUND-03, LIB-XCUT-02, TCE-EXP-01..06.
//
...
test.beforeEach(async ({ page }, testInfo) => {
  ...
  // LIVE_FINDINGS.md). This file was still using the plain `openPicker()` +
  // direct action click instead of the established
  // `openPickerReliably()` recovery helper that `drop-it.spec.js` and
  // `ai-assist.spec.js` already adopted for the same reason.
