...
test(
  'TB-BG-01: Background chooser offers multiple ruled/graph/plain styles',
  { tag: '@ui-state' },
  async ({ page }) => {
...
test(
  'TB-BG-02: Selecting a background style applies it immediately without affecting existing content',
  { tag: '@positive' },
  async ({ page }) => {
    const tb = new ToolbarPage(page);
