...
test('PLR-STU-01: Launching a Student Test opens the correct assessment for the class (scoping unresolved -- see PLR-STU-02)', { tag: '@positive' }, async ({ page }) => {
...
test('PLR-EXP-SEC-10: Launching a Student Test does not expose another student\'s attempt via a guessable ID (blocked on PLR-STU-01)', { tag: '@security' }, async ({ page }) => {
...
test('PLR-EXP-12: Launching a Student Test for a zero-student class shows a clear message (blocked on PLR-STU-01)', { tag: '@negative' }, async ({ page }) => {
